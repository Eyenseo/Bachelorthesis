      ...
      \item<+- | alert@+-+(2)>
        ...
        \begin{uncoverenv}<+->%
          \begin{tikzpicture}[overlay, remember picture]%
            \node[right=-2of cmd-pattern, yshift=.5em] (commanduml) {%
  ...
  \begin{frame}{Anforderungen}
    ...
    \begin{itemize}
      ...
      \item<+- | alert@+-+(2)>
        ...
        \begin{uncoverenv}<+>
          \begin{tikzpicture}[overlay, remember picture]%
            \node[anchor=north] at (page cs:-0.0125,-0.125) (usability exmacro) {
        ...
        \begin{uncoverenv}<+>
         \begin{tikzpicture}[overlay, remember picture]%
            \node[anchor=north] at (page cs:-0.0125,-0.125) (usability error2) {
              \begin{myInvBox}[width=.9\linewidth]
...
\section{Konzeption}
      ...
      \item<+- | alert@+-+(1)>
        ...
        \begin{uncoverenv}<+-+>%
          \begin{tikzpicture}[overlay, remember picture, railroad]%
            \node[anchor=west, yshift=-1.4em] at (page cs:-.4,0) (tokenizerMacro) {%
  ...
  \begin{frame}{AST Klassenhierarchie}
    ...
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:0,-.1) (commanduml-cat_surprised) {\includegraphics[width=.6\linewidth]{img/grumpy_cat}};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
  ...
  \begin{frame}{AST Klassen}
    \begin{tikzpicture}[remember picture,overlay,every node/.style={anchor=center}]%
      \node at (page cs:0,-.1) (Conditionuml) {%
        \scalebox{.7}{%
  ...
  \begin{frame}{Parser Klassen}
    \begin{tikzpicture}[remember picture,overlay,every node/.style={anchor=center}]%
      \node at (page cs:0,-.1) (parserpackuml) {%
        \scalebox{.7}{%
  ...
  \begin{frame}{Interpreter Klassen}
    ...
    \begin{uncoverenv}<+-+(1)>%
      \begin{tikzpicture}[remember picture,overlay,every node/.style={anchor=center}]%
        \node at (page cs:0,-.1) (interpreterpackuml) {%
...
\section{Realisierung}
  ...
  \begin{frame}{Parser}
    ...
    \begin{itemize}[<+- | alert@+>]
      ...
      \item<+- | alert@+-+(9)>
        ...
        %~~~~~~~~
        \definecolor{myLineColor0}{RGB}{255,185,20}
        \definecolor{myLineColor1}{RGB}{255,42,82}
        \definecolor{myLineColor2}{RGB}{164,36,232}
        \definecolor{myLineColor3}{RGB}{62,87,255}
        \definecolor{myLineColor4}{RGB}{72,208,224}
        \definecolor{myLineColor5}{RGB}{17,171,63}

        \begin{uncoverenv}<+-+(7)>%
          \begin{tikzpicture}[overlay, remember picture]%
            \node[coordinate] at (page cs:-.2,0) (ParserOperatorHelper){};
            \node[anchor=north west, xshift=-2em,yshift=1.3em] at (ParserOperatorHelper |- ParserOperator) (ParserOperatorCode) {%
              \lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/parser_operator1.txt}
            };%
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
        ...
        \begin{uncoverenv}<+-+(6)>%
          \begin{tikzpicture}[overlay, remember picture]%
            \draw[myLineColor0, cap=round, very thick] ($(op_p_1.west)-(0,.1)$) -- ($(op_p_4.west)-(0,.1)$);
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
              Parsen einer Deklaration(\textbf{var}).
            }
        %~~~~~~~~
        \begin{uncoverenv}<+-+(5)>%
          \begin{tikzpicture}[overlay, remember picture]%
            \draw[myLineColor1, cap=round, very thick] ($(op_p_3.west)-(0,.2)$) -- ($(op_p_4.west)-(0,.2)$);
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
              Für die Variable(\textbf{foo}).
            }
        %~~~~~~~~
        \begin{uncoverenv}<+-+(4)>%
          \begin{tikzpicture}[overlay, remember picture]%
            \draw[myLineColor2, cap=round, very thick] ($(op_p_5.west)-(0,.3)$) -- ($(op_p_12.west)-(0,.3)$);
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
              Nach dieser Funktion wird die Funktion zum Wertzuweisung -- bzw. Operator -- parsen(\textbf{=}) aufgerufen.
            }
        %~~~~~~~~
        \begin{uncoverenv}<+-+(3)>%
          \begin{tikzpicture}[overlay, remember picture]%
            \draw[myLineColor3, cap=round, very thick] ($(op_p_7.west)-(0,.4)$) -- ($(op_p_8.west)-(0,.4)$);
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
        ...
        \begin{uncoverenv}<+-+(2)>%
          \begin{tikzpicture}[overlay, remember picture]%
            \draw[myLineColor4, cap=round, very thick] ($(op_p_9.west)-(0,.5)$) -- ($(op_p_12.west)-(0,.5)$);
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
        ...
        \begin{uncoverenv}<+-+(1)>%
          \begin{tikzpicture}[overlay, remember picture]%
            \draw[myLineColor5, cap=round, very thick] ($(op_p_11.west)-(0,.6)$) -- ($(op_p_12.west)-(0,.6)$);
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
        ...
        \begin{uncoverenv}<+-+>%
          \begin{tikzpicture}[overlay, remember picture]%
            \draw[gray, line width=5mm, cap=round, opacity=0.3] ($(op_p_3.west)-(0,.4)$) -- ($(op_p_13.west)-(0,.4)$);
            \draw[gray, line width=3mm, cap=round, opacity=0.3] ($(op_p_7.west)-(0,.5)$) -- ($(op_p_13.west)-(0,.5)$);
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
        ...
        \begin{uncoverenv}<+-+>%
          \begin{tikzpicture}[overlay, remember picture]%
            \node[coordinate] at (page cs:-.2,0) (ParserOperatorHelper){};
            \node[anchor=north west, xshift=-2em,yshift=1.3em] at (ParserOperatorHelper |- ParserOperator) (ParserOperatorCode) {%
              \lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/parser_operator2.txt}
            };%
          \end{tikzpicture}%
        \end{uncoverenv}
            \note[item]<.>{
  ...
  \begin{frame}{Interpreter/Stack}
    ...
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.5,-.1) (stack int) {\myInput{img/int1.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_0)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
    ...
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.5,-.1) (stack int) {\myInput{img/int2.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_1)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
    ...
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.5,-.1) (stack int) {\myInput{img/int3.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_7)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
    ...
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.5,-.1) (stack int) {\myInput{img/int5.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_2)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
        ...
        \note[item]<.>{
          Dadurch wird eine neue Stack Instanz erzeugt, dieser kann den root Stack nach Variablen und Funktionen fragen.
        }
        \note[item]<.>{
          Dann wird in dem Stack die neue Variable \textbf{bar} angelegt, der (der String) \ldots
        }
    %~~~~~~~~
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.5,-.1) (stack int) {\myInput{img/int6.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_2)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
          Der String ``Eins Leerzeichen'' zugewiesen wird.
        }
    %~~~~~~~~
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.5,-.1) (stack int) {\myInput{img/int8.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_4)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
    ...
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.4,-.1) (stack int) {\myInput{img/intstack.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_4)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
    ...
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.5,-.1) (stack int) {\myInput{img/int9.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_9)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
    ...
    \begin{uncoverenv}<+-+(1)>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:.5,-.1) (stack int) {\myInput{img/int10.tikz}};
        \node[anchor=center] at (page cs:-.5,-.05) (stack code) {\lstinputlisting[style=MyMacroStyle, backgroundcolor=, numbers=none, frame=,escapechar=°]{img/int_macro.txt}};
        \node[anchor=center,red,fill,circle,inner sep=.3ex] (at_pos) at ($(int_macro_l_4)-(.4,.03)$){};
      \end{tikzpicture}%
    \end{uncoverenv}%
    ...
    \begin{uncoverenv}<+>%
      \begin{tikzpicture}[overlay, remember picture]%
        \node[anchor=center] at (page cs:0,0) (finish-sleepy) {\includegraphics[width=.5\linewidth]{img/sleepy_cat}};
      \end{tikzpicture}%
    \end{uncoverenv}%
        \note[item]<.>{
