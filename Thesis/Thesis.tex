...
\label{ssec:Evaluation}
  ...
  \label{sssec:Architektur}
    ...
    \paragraph{C++ Standard}
      Ein nicht so gelungener Punkt der Architektur ist, dass sich in dem \myMinin{pod} Paket keine POD Klassen nach dem C++ Standard befinden. Dies kann durchaus verwirren, wenn man POD Klassen in dem Paket erwartet.
