...
\myTodo{For-each Schleife wenn implementiert}
  ...
  \label{ssec:Level 1 -- Grundarchitektur}
    ...
    \begin{figure}[H]
      \centering
      \input{img/abstract_goal_uml.tikz}
    ...
    \begin{figure}[H]
      \centering
      \input{img/parser_pack_uml.tikz}
      % \caption{Syntax von Literals.} TODO
    ...
    \begin{figure}[H]
      \centering
      \input{img/interpreter_pack_uml.tikz}
      % \caption{Syntax von Literals.} TODO
