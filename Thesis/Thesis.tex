...
% TODO Analyser
    ...
    \label{sssec:Interpreter Architektur}
      ...
      \begin{itemize}
        \item Wenn der \myMinin{Stack} keine entsprechende Funktion besitzt, wird der \myMinin{ExecutableProvider} nach einer Funktion gefragt.\\
        ...
        \item Wenn eine Funkion interpretiert werden muss und diese von dem \myMinin{ExecutableProvider} kommt, werden die Parameter kopiert.\\
        ...
        \item Da die Parameternamen zu der Funktionssignatur gehören, ist es möglich mehrere Funktionen mit dem selben Namen anzulegen.\\ % FIXME move to analyser
          \myMinin{def fun() {...}} und \myMinin{def fun(foo) {...}} stehen also nicht in Konflikt. Die Reihenfolge der Parameter ist allerdings nicht Bestandteil der Signatur und somit ist \myMinin{def fun(a, b) {...}} und \myMinin{def fun(b, a) {...}} nicht im selben \myMinin{ast::Scope} zulässig.
