...
\lstdefinelanguage{MyMacro}{
  keywords={var, def, return, if, while, do, else, break},
...
\definecolor{terminal_color}{RGB}{210, 210, 210}
\tikzset{
  nonterminal/.style = {
    rectangle,
    rounded corners=3pt,
    ...
    top color=white!5!nonterminal_color!40,
  ...
  terminal/.style = {
    ...
    top color=white!5!terminal_color!40,
    bottom color=terminal_color,
    text height=1.5ex,
    text depth=.25ex,
    font=\ttfamily,
  },
