...
\label{sec:einleitung}
  Automatisierung ist vergleichbar mit den Maschinen die in der Industriellen Revolution auftauchten. Anstelle, dass Menschen Arbeiten müssen um ein gewünschtes Ergebnis zu bekommen, drücken sie auf einen Knopf und ein anderes System nimmt ihnen die aufwändige Arbeit ab. Dies führt dazu das Produkte schneller mit weniger Arbeitsaufwand erstellt werden können. Zudem ist die entstehende Qualität immer auf einem gleichbleibenden Level und hängt nicht vom Befinden der Arbeiter ab.

  Die P3-group arbeitet mit Airbus um Lösungen zum entwickeln von Flugzeuge zu entwickeln. Dieser Markt ist eng umkämpft wodurch minimale Gewinne einen großen Unterschied machen können. Ein Feld welches seit Jahren immer weiter durch wissenschaftliche und technische Durchbrüche durch Dezimierung optimiert wird sind die Menschlichen Ressourcen. Automatisierung sorgt dafür das Arbeitsabläufe die sich wiederholen zu einem einzigen Schritt verwandeln und so Zeit sparen.
